...
var data_json = [
  ...
  },
  {
	...
	var skills_arr; //массив скиллов по алфавиту
	
	skills_arr = _.map(data_obj, 'skills'); // массив массивов скилов
	skills_arr = _.flattenDeep(skills_arr); // склеенный массив скилов
	skills_arr = _.uniq(skills_arr);		// склеенный массив уникальных скилов	
	skills_arr = _.sortBy(skills_arr);		// по алфавиту
	
	
	console.log('Массив скиллов по алфавиту:\n\n', skills_arr);
	console.log('-----------------------------------------');
	...
	var name_arr; //массив имен людей, по возрастанию кол-ва их друзей

	name_arr = _.sortBy(data_obj, 'friends.length');	// кол-во друзей по возрастанию
	name_arr = _.map(data_obj, 'name');					// только имена с кол-вом друзей по аозрастанию
	
	console.log ('Массив имен людей по возрастанию кол-ва их друзей:\n\n', name_arr);
	console.log('-----------------------------------------');
	...
	var friends_arr;	// массив всех друзей всех людей без повторений
	
	friends_arr = _.map(data_obj, 'friends');	// массив массивов (имя друга + id)
	friends_arr = _.flattenDeep(friends_arr);	// склеенный массив (имя друга + id)
	friends_arr = _.map(friends_arr, 'name');	// массив одних лишь имен друзей (без id)
	friends_arr =_.uniq(friends_arr);			// массив уникальных имен друзей 
	
	console.log ('Массив всех друзей всех людей без повторений:\n\n', friends_arr);
